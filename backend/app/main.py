...
print(f"Lila frontend directory: {frontend_dir}", flush=True)
...
@app.get("/worker.js")
def worker():
    return FileResponse(frontend_dir / "worker.js", media_type="application/javascript", headers={"Cache-Control": "no-store"})
